## The Air BnB clone (The console) project
### The project guides on how to build the console.
### It begins with:
...
### the next is to recreate instance with dict.
...
### A data storage with Json is then created
...
### The console which is the entry point is then created
...
if __name__ == '__main__':
    HBNBCommand().cmdloop()
### The console is updated for efficiency
...
### The user clase is created Thus:
...
### More classes are created with the following properties:
...
OOP
 By: Guillaume
 Weight: 5
 Project to be done in teams of 2 people (your team: David Akpan, Ayobami Oludemi)
...
### The console storage is updated thus:
